...
namespace UnityVolumeRendering
{
    public class TransferFunctionEditor
    {
        ...
        private VolumeControllerObject volControllerObject = null;
        ...
        public void SetVolumeObject(VolumeControllerObject volControllerObject)
        {
            this.volControllerObject = volControllerObject;
        }
        ...
        public void DrawOnGUI(Rect rect)
        {
            ...
            if (volRendObject == null && volControllerObject == null)
                return;
            ...
            {
                tf = volControllerObject.transferFunction;
            }
        ...
        public Color? GetSelectedColour()
        {
            if (selectedColPointIndex != -1)
            {
                ...
                {
                    return volControllerObject.transferFunction.colourControlPoints[selectedColPointIndex].colourValue; ;
                }
                //return volRendObject.transferFunction
            }
            else
                return null;
        }
        ...
        public void RemoveSelectedColour()
        {
            ...
            if (selectedColPointIndex != -1)
            {
                tf.colourControlPoints.RemoveAt(selectedColPointIndex);
                selectedColPointIndex = -1;
            }
        }
