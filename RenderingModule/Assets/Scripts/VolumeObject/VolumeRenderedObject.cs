...
namespace UnityVolumeRendering
{
    ...
    public class VolumeRenderedObject : MonoBehaviour
    {
        ...
        [SerializeField, HideInInspector]
        public float highlightRadius = 1;
        ...
        private async Task UpdateMaterialPropertiesAsync(IProgressHandler progressHandler = null)
        {
            ...
            try
            {
                ...
                bool useGradientTexture = renderMode == RenderMode.DirectVolumeRendering || renderMode == RenderMode.IsosurfaceRendering;
        ...
        private void UpdateMatInternal()
        {
            ...
            meshRenderer.sharedMaterial.SetFloat("_CircleX", highlightPosition.x);
            meshRenderer.sharedMaterial.SetFloat("_CircleY", highlightPosition.y);
            meshRenderer.sharedMaterial.SetFloat("_CircleRadius", highlightRadius);
